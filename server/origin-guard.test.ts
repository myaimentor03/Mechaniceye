...
test("originPermitted accepts list members and rejects everything else", () => {
  ...
  assert.equal(originPermitted("https://getdrivable.com"), true);
  assert.equal(originPermitted("https://www.getdrivable.com"), true);
  ...
  assert.equal(originPermitted("https://getdrivable.com.evil.example.com"), false);
