...
import { Check, Mic, Video, Waves, Edit, Image, X, Shield, AlertCircle } from "lucide-react";
import { AudioRecorder } from "@/components/AudioRecorder";
import { VideoRecorder } from "@/components/VideoRecorder";
import { VibrationCapture } from "@/components/VibrationCapture";
import { PhotoRecorder } from "@/components/PhotoRecorder";
import { type MediaCapabilities, MEDIA_UNAVAILABLE, mediaUnavailableMessage } from "@/lib/mediaAvailability";
import { MAX_PHOTO_COUNT } from "@/lib/photoValidation";
        ...
        return (
          <div className="space-y-4">
            <PhotoRecorder
              ...
              onChange={(files) => setFormData((prev: any) => ({ ...prev, photoFiles: files }))}
              onError={handleError}
            />
          </div>
        );
